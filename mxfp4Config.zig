...
// Extracts MXFP4 tensor configs from the list of a safetensors file's tensor configs.
// This is done by prefix-matching the blocks (ending in "_blocks") and the scales (ending in "_scales") tensor configs.
